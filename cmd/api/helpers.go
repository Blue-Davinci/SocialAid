...
// writeJSON()  writes the status code, headers, and JSON response data to the http.ResponseWriter.
// The status code is passed as the first parameter, the data to be encoded to JSON is passed as the second parameter, and the headers are passed as the third parameter.
// The function returns an error if there was a problem encoding the data to JSON, or writing the response.
